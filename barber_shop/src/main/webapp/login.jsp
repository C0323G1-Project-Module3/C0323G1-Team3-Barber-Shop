...
<div class="page-content">
    <div class="form-v8-content">
        ...
        <div class="form-right" style="margin-top: 1.5rem">
            <div class="tab">
                <div class="tab-inner">
            ...
            <form class="form-detail" action="CustomerServlet?action=create" method="post">
                <div class="tabcontent" id="sign-up" style="display:block;">
                    ...
                    <div class="form-row">
                        <label class="form-row-inner">
                            <span class="label">Chọn giới tính :</span><br/>
                            <span class="border"></span>
                        </label>
                    </div>
                    <div class="form-row">
                        <select name="gender" id="gender" style="margin-left:12px;background: #d3ceb8;color:#425d54 ; padding: 0.5rem 2rem; border-radius: 10px">
                    ...
                    <div class="form-row-last">
                        <input type="submit" name="register" onclick="validate()" class="register" value="Đăng kí">
                    </div>
                </div>
            </form>
            <form class="form-detail" action="/AccountServlet?action=login" method="post">
                <div class="tabcontent" id="sign-in" style="display:none;">
                    ...
                    <div class="form-row">
                        <label class="form-row-inner">
                            <input type="password" name="password" id="password2" class="input-text"
                                   required>
                            <span class="label">Mật khẩu :</span>
                            <span class="border"></span>
                        </label>
...
<script>
    ...
    function validate() {
        ...
        if (username === '' || username.length < 5 || !/^[a-zA-Z0-9]+$/.test(username)) {
            flag = false;
            showError('username', 'Ít nhất 5 kí tự');
        }

        // 2. password
        let password = getValue('password');
        let repassword = getValue('repassword');
        if (password === '' || password.length < 3 || password !== repassword) {
            flag = false;
