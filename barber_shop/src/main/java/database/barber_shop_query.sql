...
delimiter //
create procedure edit_employee(employe_id int, employee_name varchar(255), birthday VARCHAR(10), salary double, phone_number varchar(10), gender bit, id_card varchar(12), address varchar(255))
begin
